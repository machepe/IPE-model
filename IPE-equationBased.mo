...
package IPE_rovnice
  ...
  partial model Part
    ...
    parameter Real imE(unit="mmol/l") = 95/0.73;
    ...
    parameter Real imI(unit="mmol/l") = 4.6;
    //charge on inpermeable solutes
    parameter Real ZimE = -7.7;
    parameter Real ZimI = -0.7;
    parameter Real ZimP = -6.9;
